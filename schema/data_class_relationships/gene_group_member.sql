...
ALTER TABLE dataclass_relationship.gene_group_member ADD COLUMN id SERIAL PRIMARY KEY;

ALTER TABLE dataclass_relationship.gene_group_member ADD CONSTRAINT gene_group_member_unique UNIQUE (gene_id, gene_group_id, subgroup_id);
